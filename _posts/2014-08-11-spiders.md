...
tags: [spiders,full-stack,developer]
---
{% include JB/setup %}
...
<div class="imageBlock"><img source="/assets/images/big-architecture.jpg" alt="A Complicated Web Architecture" width="97%" height="400"> <span class="caption">(From http://docs.openstack.org/)</span></div>
